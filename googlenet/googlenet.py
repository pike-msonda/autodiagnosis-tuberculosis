...
def create_googlenet(weights_path=None, input_shape=(3, 224, 224)):
    ...
    # loss3_flat = SpatialPyramidPooling([1,2,3,4,5,6])(pool5_7x7_s1)
    pool5_drop_7x7_s1 = Dropout(rate=0.4)(loss3_flat)
    loss3_classifier = Dense(2, name='loss3/classifier', kernel_regularizer=l2(0.0002))(pool5_drop_7x7_s1)
    loss3_classifier_act = Activation('softmax', name='prob')(loss3_classifier)

    googlenet = Model(inputs=input,outputs=[loss1_classifier_act,loss2_classifier_act,loss3_classifier_act], name='googlenet')
