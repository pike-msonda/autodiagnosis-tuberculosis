...
if __name__ == '__main__':
    ...
    if not (os.path.exists('../models/googlelenetV1.h5')):

        # googlelenet = GoogleLeNet(input_shape=(227,227, 3), classes=2)
        ...
        #TRAIN MODEL
        model.fit(x, y, batch_size=20, epochs=120, verbose=1, \
        validation_split=0.2, shuffle=True, callbacks=[HistoryCallback('../history/history.csv')])
        
        store_model(model, "../models/", "googlelenetV1")